...
object BinaryClassificationSpamEc2 extends App {

  val conf = new SparkConf().setAppName("BinaryClassificationSpamEc2")//.setMaster("spark://ec2-54-159-166-156.compute-1.amazonaws.com:7077")
  val sc = new SparkContext(conf)
  val sqlContext = new SQLContext(sc)

  val docs = sc.textFile("hdfs://ec2-54-161-176-58.compute-1.amazonaws.com:9000/scalada/SMSSpamCollection").map(line => {
